...
# Target size range in bytes (500 KB to 1 MB)
...
async def compress_pdf_endpoint(file: UploadFile, background_tasks: BackgroundTasks):
    """Endpoint to upload and compress a PDF file to 500 KB–1 MB."""
...
@app.get("/")
async def root():
    return {"message": "PDF Compression API is running. Use /compress-pdf/ to upload and compress a PDF."}
